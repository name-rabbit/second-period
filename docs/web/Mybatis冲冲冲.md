...
自学缺点：
1.选择范围过大，不知道自己学什么
2.容易失去动力，缺乏压力，容易丢失新鲜感，
3.知识体系不够完整
怎么自学：
1.不能忽视编程的基础，如计算机网络、数据结构、编译原理等，这是通往高阶的基石
2.制定属于自己的计划
3.制定时间表
4.找一位老师，老师可以给出方向，但别指望老师给出具体的答案
5.一定要有自己的输出，我觉得不仅可以是项目，博客，笔记（用输出倒逼输入）
Ps:大学别太指望老师，大学的课堂内容很多已经过时，自学加上自律才是王道，![[OK]](https://i0.hdslb.com/bfs/emote/4683fd9ffc925fa6423110979d7dcac5eda297f4.png)。